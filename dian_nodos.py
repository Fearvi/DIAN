...
NODOS = {
    "nodo-1-mac-principal": {
        ...
        "puerto": 8765,
        "platform": "macos",
        "descripcion": "MBP 2019 Intel i7 16GB — Nodo principal",
        "modelos": {
            "principal":  "lfm2:latest",
            "consenso":   "mistral:7b",
            "rag":        "llama3.1:latest",
            "multimodal": "qwen3.5:4b",
            "ligero":     "qwen3.5:2b",
            "embed":      "nomic-embed-text",
            "thinking":   "lfm2.5-thinking:latest",
            "lora":       "phi3:mini",
        },
    },
    "nodo-2-mbp2011": {
        ...
        "puerto": 8766,
        "platform": "macos",
        "descripcion": "MBP 2011 Intel i7 16GB — Nodo 2 (pendiente OCLP)",
        "modelos": {
            "principal": "phi3:mini",
        },
    },
    "nodo-3-redmi": {
        ...
        "puerto": 8766,
        "platform": "android",
        "descripcion": "Redmi 14C Android 8GB — Nodo móvil",
        "modelos": {
            "principal": "lfm2.5-thinking:latest",
            "ligero":    "qwen3.5:2b",
        },
    },
}
